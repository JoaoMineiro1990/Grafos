...
\documentclass[a4paper,brazil,ruledheader,normaltoc,capchap,oneside]{abnt_pucmg_utf8}
\usepackage{rotating}
\usepackage{graphicx}
...
%%\pdfinfo{%
%%  /Title    (UM ESTUDO SOBRE O PROBLEMA DO CASAMENTO ESTÁVEL)
%%  /Author   (Rafael Oliveira Lima Peixoto \\Gabriela Lacerda Muniz)
%%  /Creator  (Rafael Oliveira Lima Peixoto)
%%  /Producer (Kile - an Integrated LaTeX Environment - %%Version 2.0.85)
%%  /Subject  (Dissertação tabalho interdisciplinar)
...
\autor{Gabriela Lacerda Muniz \\ João Vitor Mendes Moreira}
...
\titulo{Segundo Trabalho Prático}
...
% Texto
\comentario{Trabalho Prático da disciplina de Teoria dos Grafos e Computabilidade - Aplicado no curso de Ciência da Computação da Pontifícia Universidade Católica de Minas Gerais.}
...
\include{texto/capEx1}
\include{texto/capEx2}
\include{texto/capEx3}
